...
public class InvoText {
    ...
    public static InvoText translate(String txt, Object... args){
        return new InvoText(new TranslatableComponent(txt, args));
    }

    public static InvoText literal(String txt){
        return new InvoText(new TextComponent(txt));
    }
    ...
    public InvoText setArgs(Object... args){
        if (!(this.textComponent instanceof TranslatableComponent)) {
            return InvoText.literal("This is not a translation component! [InvoText]");
        }
        InvoText newText = InvoText.translate(((TranslatableComponent)this.textComponent).getKey(), args);
